...
export declare class Sequence_Grant extends TerraformResource {
    ...
    readonly _id: string;
    constructor(scope: Construct, id: string, config: Sequence_GrantConfig);
    getAttributes(): {
        [name: string]: any;
    };
    get id(): string;
    ...
    get sequence_name(): string | undefined;
    set sequence_name(value: string | undefined);

...
export interface Task_GrantConfig extends TerraformMetaArguments {
...
export declare class Task_Grant extends TerraformResource {
    ...
    readonly _id: string;
    constructor(scope: Construct, id: string, config: Task_GrantConfig);
    getAttributes(): {
        [name: string]: any;
    };
    get id(): string;
    ...
    get task_name(): string | undefined;
    set task_name(value: string | undefined);

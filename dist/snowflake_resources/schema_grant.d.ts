...
export interface Schema_GrantConfig extends TerraformMetaArguments {
...
export declare class Schema_Grant extends TerraformResource {
    ...
    readonly _id: string;
    constructor(scope: Construct, id: string, config: Schema_GrantConfig);
    getAttributes(): {
        [name: string]: any;
    };
    get id(): string;

...
export declare class External_Oauth_Integration extends TerraformResource {
    ...
    get token_user_mapping_claims(): Set<string>;
    set token_user_mapping_claims(value: Set<string>);
    get type(): string;
    set type(value: string);
    get allowed_roles(): Set<string> | undefined;
    set allowed_roles(value: Set<string> | undefined);
    get any_role_mode(): string | undefined;
    set any_role_mode(value: string | undefined);
    get audience_urls(): Set<string> | undefined;
    set audience_urls(value: Set<string> | undefined);
    get blocked_roles(): Set<string> | undefined;
    set blocked_roles(value: Set<string> | undefined);
    get comment(): string | undefined;
    set comment(value: string | undefined);
    get jws_keys_urls(): Set<string> | undefined;
    set jws_keys_urls(value: Set<string> | undefined);

...
export interface Row_Access_Policy_GrantConfig extends TerraformMetaArguments {
...
export declare class Row_Access_Policy_Grant extends TerraformResource {
    _database_name: string;
    _row_access_policy_name: string;
    _schema_name: string;
    ...
    readonly _id: string;
    constructor(scope: Construct, id: string, config: Row_Access_Policy_GrantConfig);
    getAttributes(): {
        [name: string]: any;
    };
    get id(): string;
    ...
    get row_access_policy_name(): string;
    set row_access_policy_name(value: string);

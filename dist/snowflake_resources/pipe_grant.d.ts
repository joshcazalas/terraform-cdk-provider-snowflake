...
export declare class Pipe_Grant extends TerraformResource {
    ...
    readonly _id: string;
    constructor(scope: Construct, id: string, config: Pipe_GrantConfig);
    getAttributes(): {
        [name: string]: any;
    };
    get id(): string;
    ...
    get pipe_name(): string | undefined;
    set pipe_name(value: string | undefined);

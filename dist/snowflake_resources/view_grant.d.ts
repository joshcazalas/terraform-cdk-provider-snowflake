...
export interface View_GrantConfig extends TerraformMetaArguments {
...
export declare class View_Grant extends TerraformResource {
    ...
    readonly _id: string;
    constructor(scope: Construct, id: string, config: View_GrantConfig);
    getAttributes(): {
        [name: string]: any;
    };
    get id(): string;
    ...
    get view_name(): string | undefined;
    set view_name(value: string | undefined);

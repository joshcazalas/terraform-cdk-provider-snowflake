...
export declare class Masking_Policy_Grant extends TerraformResource {
    ...
    readonly _id: string;
    constructor(scope: Construct, id: string, config: Masking_Policy_GrantConfig);
    getAttributes(): {
        [name: string]: any;
    };
    get id(): string;
    ...
    get masking_policy_name(): string;
    set masking_policy_name(value: string);

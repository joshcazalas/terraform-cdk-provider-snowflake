...
export class Schema_Grant extends TerraformResource {
    ...
    public constructor(scope: Construct, id: string, config: Schema_GrantConfig) {
        super(scope, id, {
    ...
    public ref(attribute: string): string {
        return `\${snowflake_schema_grant.${this.friendlyUniqueId}.${attribute}}`;
    }

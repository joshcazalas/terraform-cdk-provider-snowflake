...
export class Procedure_Grant extends TerraformResource {
    ...
    public constructor(scope: Construct, id: string, config: Procedure_GrantConfig) {
        super(scope, id, {
        ...
        this._procedure_name = config.procedure_name;
    ...
    public getAttributes(): { [name: string]: any } {
        return {
            ...
            procedure_name: this._procedure_name,
    ...
    public ref(attribute: string): string {
        return `\${snowflake_procedure_grant.${this.friendlyUniqueId}.${attribute}}`;
    }
    ...
    public get argument_data_types(): string[] | undefined {
        return this._argument_data_types
    }

    public set argument_data_types(value: string[] | undefined) {
    ...
    public get procedure_name(): string | undefined {
        return this._procedure_name
    }

    public set procedure_name(value: string | undefined) {

...
export class Task_Grant extends TerraformResource {
    ...
    public constructor(scope: Construct, id: string, config: Task_GrantConfig) {
        super(scope, id, {
    ...
    public get task_name(): string | undefined {
        return this._task_name
    }

    public set task_name(value: string | undefined) {

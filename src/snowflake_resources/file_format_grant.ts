...
export class File_Format_Grant extends TerraformResource {
    ...
    public constructor(scope: Construct, id: string, config: File_Format_GrantConfig) {
        super(scope, id, {
        ...
        this._file_format_name = config.file_format_name;
    ...
    public getAttributes(): { [name: string]: any } {
        return {
            ...
            file_format_name: this._file_format_name,
            on_all: this._on_all,
    ...
    public ref(attribute: string): string {
        return `\${snowflake_file_format_grant.${this.friendlyUniqueId}.${attribute}}`;
    }
    ...
    public get file_format_name(): string | undefined {
        return this._file_format_name
    }

    public set file_format_name(value: string | undefined) {
        this._file_format_name = value;
    }

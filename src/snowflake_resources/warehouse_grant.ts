...
export class Warehouse_Grant extends TerraformResource {
    ...
    public constructor(scope: Construct, id: string, config: Warehouse_GrantConfig) {
        super(scope, id, {
        ...
        this._warehouse_name = config.warehouse_name;
    ...
    public getAttributes(): { [name: string]: any } {
        return {
            warehouse_name: this._warehouse_name,
    ...
    public ref(attribute: string): string {
        return `\${snowflake_warehouse_grant.${this.friendlyUniqueId}.${attribute}}`;
    }

    public get warehouse_name(): string {
        return this._warehouse_name
    }

    public set warehouse_name(value: string) {

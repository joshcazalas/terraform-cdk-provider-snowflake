...
export class Function_Grant extends TerraformResource {
    ...
    public constructor(scope: Construct, id: string, config: Function_GrantConfig) {
        super(scope, id, {
    ...
    public get function_name(): string | undefined {
        return this._function_name
    }

    public set function_name(value: string | undefined) {

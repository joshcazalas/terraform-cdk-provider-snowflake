...
export class Row_Access_Policy_Grant extends TerraformResource {
    ...
    public constructor(scope: Construct, id: string, config: Row_Access_Policy_GrantConfig) {
        super(scope, id, {
        ...
        this._row_access_policy_name = config.row_access_policy_name;
    ...
    public getAttributes(): { [name: string]: any } {
        return {
            ...
            row_access_policy_name: this._row_access_policy_name,
    ...
    public ref(attribute: string): string {
        return `\${snowflake_row_access_policy_grant.${this.friendlyUniqueId}.${attribute}}`;
    }

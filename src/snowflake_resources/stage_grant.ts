...
export class Stage_Grant extends TerraformResource {
    ...
    public constructor(scope: Construct, id: string, config: Stage_GrantConfig) {
        super(scope, id, {
    ...
    public get stage_name(): string | undefined {
        return this._stage_name
    }

    public set stage_name(value: string | undefined) {

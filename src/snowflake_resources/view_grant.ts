...
export class View_Grant extends TerraformResource {
    ...
    public constructor(scope: Construct, id: string, config: View_GrantConfig) {
        super(scope, id, {
        ...
        this._view_name = config.view_name;
    ...
    public ref(attribute: string): string {
        return `\${snowflake_view_grant.${this.friendlyUniqueId}.${attribute}}`;
    }
    ...
    public get view_name(): string | undefined {
        return this._view_name
    }

    public set view_name(value: string | undefined) {
